/**
 * Client Edit Screen - OnSite Timekeeper
 *
 * Full-screen form to edit invoice recipient (client). Reached from the Invoice
 * Detail screen via "Send To" card — never rendered as a modal.
 *
 * Params:
 *   invoiceId      — optional. When present, flags post-save snackbar with
 *                    "View Invoice" action that re-opens the Detail modal.
 *   invoiceNumber  — optional. Shown in snackbar text.
 *   clientName     — optional. Used to prefill the form for an existing client.
 */
