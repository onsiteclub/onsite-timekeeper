...
export function generateHourlyInvoiceHTML(params: {
  ...
  const { invoiceNumber, businessProfile, clientName, clientAddress, days, hourlyRate, taxRate, periodStart, periodEnd, dueDate } = params;
...
export function generateProductsInvoiceHTML(params: {
  ...
  const { invoiceNumber, businessProfile, clientName, clientAddress, items, taxRate, dueDate } = params;
