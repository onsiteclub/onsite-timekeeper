 ...
 *
 * Used in:
 * - Wizard Step 3 (edit TO on new invoice)
 * - Invoice Detail Modal (edit TO on saved invoice)
 *
 * Construction-worker-friendly: large inputs (56px), big buttons, clear labels.
 */
