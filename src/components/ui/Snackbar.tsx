/**
 * Snackbar - OnSite Timekeeper
 *
 * Bottom toast with optional action button. Auto-dismiss + manual swipe-to-dismiss.
 * Rendered globally in app/_layout.tsx. Driven by useSnackbarStore.
 */
